...
def generate_qr_code(request):
    menu_url = request.build_absolute_uri('/') + 'services'
...
def Home(request):
    ...
    facilities = Facility.objects.all()
    categories = Category.objects.all()
    return render(request,'home.html',{'services':services,'background_image':background_image,'facilities':facilities,'categories':categories,'about':about })
